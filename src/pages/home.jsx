...
function Home() {
  return (
    <section className="relative flex min-h-[calc(100vh-73px)] flex-col overflow-hidden bg-[#0a0a0a] text-white">
        ...
        <div className="grid flex-1 grid-cols-1 items-stretch lg:grid-cols-[1.02fr_0.98fr]">
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <img
              ...
              style={{
                filter: "contrast(1.08) drop-shadow(0 0 28px rgba(0,0,0,0.2))",
              }}
            />
          </div>
        </div>
      ...
      <div className="relative border-t border-white/10 bg-[#111111]">
