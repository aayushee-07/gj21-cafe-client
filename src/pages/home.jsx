...
function Home() {
  return (
    <section className="relative flex min-h-[calc(100vh-73px)] flex-col overflow-hidden bg-[#24110d] text-white">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.03)_0%,rgba(0,0,0,0)_45%),linear-gradient(to_bottom,rgba(255,255,255,0.02),transparent_12%,transparent_88%,rgba(0,0,0,0.24))]" />

      <div className="relative mx-auto flex w-full max-w-[1440px] flex-1 flex-col px-5 sm:px-6 lg:px-8">
        <div className="flex h-[74px] items-center justify-between bg-[#ddd7d2] px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-baseline gap-2 text-[30px] font-extrabold tracking-[-0.04em] text-[#2f2925]">
              <span>GJ</span>
          ...
          <div className="hidden items-center gap-10 md:flex">
            <nav className="flex items-center gap-10 text-[18px] font-medium text-[#5f5751]">
        ...
        <div className="grid flex-1 grid-cols-1 items-center lg:grid-cols-[45%_55%]">
          <div className="flex flex-col justify-center px-2 py-10 sm:px-4 lg:px-0 lg:py-0">
            <h1 className="max-w-[620px] text-[46px] font-extrabold leading-[0.94] tracking-[-0.05em] text-white sm:text-[60px] md:text-[72px] lg:text-[90px]">
              Welcome to
              <br />
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_56%_42%,rgba(255,255,255,0.08)_0%,rgba(255,255,255,0.03)_12%,rgba(0,0,0,0)_40%)]" />
            <img
              src={cafeImage}
              alt="GJ 21 Cafe Logo"
              className="relative w-[440px] max-w-none object-contain mix-blend-screen sm:w-[540px] md:w-[650px] lg:w-[780px] xl:w-[860px]"
              style={{
                filter: "contrast(1.04) drop-shadow(0 0 26px rgba(255,255,255,0.03))",
              }}
            />
          </div>
        </div>
